...
def isolated_agent(
    ...
    def decorator(func: F) -> F | Callable[..., Any]:
        ...
        return cast(
            F, async_wrapper if async_mode or inspect.iscoroutinefunction(func) else sync_wrapper
        )
...
def langchain(packages: list[str] | None = None) -> Callable[[F], F]:
