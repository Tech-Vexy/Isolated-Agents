...
class AuditAdapter(BaseAdapter):
    ...
    async def export_events(
        ...
        """
        raise NotImplementedError(f"{self.__class__.__name__} does not support event export")
    ...
    async def archive_events(
        ...
        """
        raise NotImplementedError(f"{self.__class__.__name__} does not support event archiving")
