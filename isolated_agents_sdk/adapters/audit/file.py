...
class FileAuditAdapter(AuditAdapter):
    ...
    async def log_event(
        ...
        try:
            ...
            raise AdapterOperationError(f"Failed to write audit event: {e}")
    ...
    async def get_event(
        ...
        raise AdapterOperationError(f"Event {event_id} not found")
    ...
    async def delete_events(
        ...
        for log_file in log_files:
            ...
            try:
                ...
                raise AdapterOperationError(f"Failed to rewrite log file: {e}")
    ...
    def _matches_query(self, event: AuditEvent, query: AuditQuery) -> bool:
        ...
        return not (query.severity and event.severity != query.severity)
