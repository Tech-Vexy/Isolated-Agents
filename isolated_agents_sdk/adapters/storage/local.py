...
class LocalStorageAdapter(StorageAdapter):
    ...
    async def store_artifact(
        ...
        try:
            ...
            raise AdapterOperationError(f"Failed to write artifact {artifact_name}: {e}")
    ...
    async def retrieve_artifact(
        ...
        try:
            ...
            raise AdapterOperationError(f"Failed to read artifact {artifact_name}: {e}")
    ...
    async def delete_artifact(
        ...
        try:
            ...
            raise AdapterOperationError(f"Failed to delete artifact {artifact_name}: {e}")
    ...
    async def delete_session(
        ...
        if session_dir.exists():
            try:
                ...
                raise AdapterOperationError(f"Failed to delete session {session_id}: {e}")
