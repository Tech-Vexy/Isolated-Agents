...
class KubernetesAdapter(ContainerRuntimeAdapter):
    ...
    def __init__(
        self, namespace: str = "default", context: str | None = None, timeout: float = 300, **kwargs
    ):
    ...
    async def provision_container(
        ...
        if self._context:
            wait_cmd.insert(1, "--context")
            wait_cmd.insert(2, self._context)
